<template>
	<div
		class="wb-tokens-input-impl-old"
		@keydown="onkeydown">
...
.wb-tokens-input-impl-old > .-fake-input {
	flex: 0 0 auto;
...
.wb-tokens-input-impl-old > .-fake-input.--last {
	flex: 1 1 auto;
}

.wb-tokens-input-impl-old > .-token {
	user-select: none;
...
.wb-tokens-input-impl-old > .-token + .-token {
	/*margin-left: 0.2em;*/
}
